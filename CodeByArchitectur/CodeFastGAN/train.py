...
from models import weights_init, Discriminator, Generator, CustomDataset
...
def train(args):
    ...
    if 'lmdb' in data_root:
        ...
        for f in glob(os.path.join(data_root, "*.png"), recursive=True):
            file_list.append(f)
    
        print(len(file_list))
        dataset = CustomDataset(file_list, transform=trans)
        #ImageFolder(root=data_root, transform=trans)
