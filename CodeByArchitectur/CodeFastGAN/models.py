...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        nfc_multi = {4:16, 8:8, 16:4, 32:2, 64:2, 128:1, 256:0.5, 512:0.25, 1024:0.125} # REVIEW: Anzahl an Channel pro Höhe/Breite des Bildes!
        nfc = {}
...
class Discriminator(nn.Module):
    ...
    def forward(self, imgs, label, part=None):
        ...
        feat_2 = self.down_from_big(imgs[0])      # REVIEW Done  
        feat_4 = self.down_4(feat_2)              # REVIEW Done
        feat_8 = self.down_8(feat_4)              # REVIEW Done
        
        feat_16 = self.down_16(feat_8)            # REVIEW Done
        feat_16 = self.se_2_16(feat_2, feat_16)   # REVIEW Done

        feat_32 = self.down_32(feat_16)           # REVIEW Done
        feat_32 = self.se_4_32(feat_4, feat_32)   # REVIEW Done
        
        feat_last = self.down_64(feat_32)         # REVIEW Done
        feat_last = self.se_8_64(feat_8, feat_last) # REVIEW Done
